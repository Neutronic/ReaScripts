--[[
Description: Quick Adder 2 -- optimize GUI size for 4k
About: Optimizes Quick Adder 2 window size for 4k screen resolution.
Version: 1.0
Author: Neutronic
...
reaper.SetExtState("Quick Adder", "ACT", "|4k", false)
