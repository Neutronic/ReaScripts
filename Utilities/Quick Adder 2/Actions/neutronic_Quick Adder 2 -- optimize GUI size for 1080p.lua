--[[
Description: Quick Adder 2 -- optimize GUI size for 1080p
About: Optimizes Quick Adder 2 window size for 1080p screen resolution.
Version: 1.0
Author: Neutronic
...
reaper.SetExtState("Quick Adder", "ACT", "|1080p", false)
